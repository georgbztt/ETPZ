...
class NotasForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'lapso_1': TextInput(attrs={'class':'form-control'}),
            'lapso_2': TextInput(attrs={'class':'form-control'}),
            'lapso_3': TextInput(attrs={'class':'form-control'}),
            'reparacion': TextInput(attrs={'class':'form-control'}),
        }
